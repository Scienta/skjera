# Rust API for skjera_api

Scienta's internal API for figuring out what's shakin'!
...
- API version: 1.0.0
- Build date: 2024-12-25T08:00:35.846582037+01:00[Europe/Oslo]
- Generator version: 7.9.0



This autogenerated project defines an API crate `skjera_api` which contains:
...
#[async_trait]
impl skjera_api::Api for ServerImpl {
